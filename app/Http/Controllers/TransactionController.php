...
class TransactionController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        try {
            ...
            // Lempar seluruh data request ke Queue Job untuk diproses di latar belakang
            ProcessCheckoutJob::dispatch($user->id, $request->all());

            // Kembalikan respons instan 202 Accepted dalam rentang milidetik!
            return response()->json([
                'status' => 'processing',
                'message' => 'Pesanan Anda sedang diproses di latar belakang.'
            ], 202);
